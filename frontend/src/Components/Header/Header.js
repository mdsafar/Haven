                ...
                <div className="navigation">
                    <ul className="menu">
                        {nav_link.map((items,index) => {
                            return <li key={index} className="nav_items "><NavLink className={(navActive) => navActive.isActive ? "nav_active" : ""} to={items.path}>{items.display}</NavLink></li>
                        })}
                    </ul>
                </div>
                <div className="nav_right ">
                    ...
                    <div className="fav-bag ">
                        <div className="bag-icon">
                            <Link to="/bag"><i class="ri-handbag-line"></i>
                            {bagItems &&
                            bagItems.length > 0 && ( 
                         ...
                         <div className="options">
                           <UserOptions/>
                            ...
                            <div className="acc_icon">
                                <Link to="/login"> <i class="ri-account-circle-line"></i></Link>
                            </div>
                        )
                        }
                    </div>
