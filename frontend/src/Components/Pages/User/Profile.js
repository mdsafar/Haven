...
const Profile = () => {
    ...
    const LogoLetter = isAuthenticated ? user.name.split(' ').map(word => word.charAt(0))[0].toUpperCase():null;
                   ...
                   <div className="details_container d-flex align-items-center justify-content-center">
                    <div className="user_details">
                        ...
                        <div className="buttons">
                            <button className="frst_btn"><Link to="/me/update">Update Profile</Link></button>
                            <button onClick={handleLogout} className="scnd_btn"><Link to="/">LogOut</Link></button>
                        </div>
                        </div>
                </div>
            </div>
