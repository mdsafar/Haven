            ...
            <div className="main-details-container">
              <div className="single-pro-details">
                ...
                <div className="review-submit-section">
                  <div
                    className="review-box d-flex justify-content-between align-items-center"
                ...
                >
                  <div
                    className="reviews-section d-flex justify-content-between align-items-center"
